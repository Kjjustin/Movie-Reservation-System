    ...
    <body>
          ...
          <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">BookMyTicket</a>
              </div>
      ...
      <section class="showtime_page">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <p style="font-size: 3vw; font-weight: bold;text-align: center;">This Project was made for DBMS Laboratory Mini - Project</p>
              <p style="font-weight: bold">Group Members :</p>
              <ul>
                <li><b>KJ Justin 4SU21CS040</b></li>
                <li><b>Prajwal Pai 4SU21CS059</b></li>
                <li><b>Nihas NS 4SU21CS067</b></li>
              </ul>
